...
@Component
@Scope("prototype")
public class OrPredicate extends RelationPredicate
{
	public OrPredicate(PredicateArray predicates)
	{
		super(predicates);
	}
	...
	{
		return Arrays.stream(getPredicates()).anyMatch(Predicate::isSatisfied);
	}
