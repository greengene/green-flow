...
@Service
public class FlowControllerSymbolicNameService extends ClassSymbolicNameService<FlowController>
{
	@Autowired
	private FlowControllerTypeService flowControllerTypeService;

	@Override
	protected void syncClassTypeService(Class<? extends FlowController> clazz)
	{
	}
}